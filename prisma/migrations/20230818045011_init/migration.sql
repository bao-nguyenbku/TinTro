...
-- CreateEnum
CREATE TYPE "ServiceStatus" AS ENUM ('PURCHASED', 'NONE');
...
CREATE TABLE "Renting" (
    ...
    "status" "RentingStatus" NOT NULL DEFAULT 'RENTING',
...
CREATE TABLE "Room" (
    ...
    "personNumber" INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE "Wifi" (
    ...
    "password" TEXT NOT NULL,
    "speed" TEXT NOT NULL,
    "purchaseStatus" "ServiceStatus" NOT NULL,
...
CREATE TABLE "Parking" (
    ...
    "color" TEXT NOT NULL,
    "price" INTEGER NOT NULL DEFAULT 0,
    "purchaseStatus" "ServiceStatus" NOT NULL DEFAULT 'PURCHASED',
    "startDate" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "RentRequest_renterId_key" ON "RentRequest"("renterId");

-- CreateIndex
CREATE UNIQUE INDEX "Renting_renterId_key" ON "Renting"("renterId");

-- CreateIndex
CREATE UNIQUE INDEX "Wifi_roomId_key" ON "Wifi"("roomId");

-- CreateIndex
CREATE UNIQUE INDEX "Parking_renterId_key" ON "Parking"("renterId");
...
-- AddForeignKey
ALTER TABLE "Wifi" ADD CONSTRAINT "Wifi_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "Room"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Parking" ADD CONSTRAINT "Parking_renterId_fkey" FOREIGN KEY ("renterId") REFERENCES "Renter"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Parking" ADD CONSTRAINT "Parking_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "Room"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
