    ...
    <Box bgColor='white' rounded='xl' width='240px' marginRight='8'>
      <Box>
        ...
        <Box 
          ...
          <Text marginLeft="4px" color='white'>{data.reviewStar}</Text>
        </Box>
      </Box>
      <VStack padding='2' space='1'>
        ...
        <Box alignItems="center" flexDirection="row" flex={1}>
          ...
          <Text marginLeft="4px" flex={1} flexWrap='wrap' color='muted.500'>{[data.addressNumber, data.addressStreet, data.addressDistrict, data.addressCity].join(', ')}</Text>
        </Box>
